...
read -p "Insert origin 1 address (example payment1) : " origin1 && ${cardano_script_path}/query-utxo.sh ${origin1}
read -p "Insert tx-in : " txIn1
read -p "Insert tx-in id : " txInId1

read -p "Insert origin 2 address (example payment2) : " origin2 && ${cardano_script_path}/query-utxo.sh ${origin2}
